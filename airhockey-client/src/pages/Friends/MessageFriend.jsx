    ...
    <div className='message-container' onClick={closeContextMenu}>
      ...
      <div className='chat-section'>
        <div className='message-header'>
          {selectedContact
            ? `${translations.page.messageUser.chatWith} ${selectedContact.username}`
            : translations.page.messageUser.selectContact}
        </div>
      ...
      {contextMenu && (
        ...
        >
          {messages.find((msg) => msg._id === contextMenu.messageId)
          ...
          <button onClick={closeContextMenu}>
            {translations.page.messageUser.cancel}
          </button>
        </div>
      )}
    </div>
