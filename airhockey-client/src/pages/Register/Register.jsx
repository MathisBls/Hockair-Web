          ...
          <form onSubmit={handleSubmit}>
            <div className='form-group-register'>
              <label htmlFor='username'>
                {translations.page.register.username}
              </label>
              <input
                type='text'
                id='username'
            ...
            <div className='form-group-register'>
              <label htmlFor='password'>
                {translations.page.register.password}
              </label>
              <input
                type='password'
                id='password'
            ...
            <div className='form-group-register'>
              <label htmlFor='confirmPassword'>
                {translations.page.register.confirmPassword}
              </label>
              <input
                type='password'
                id='confirmPassword'
                ...
                onChange={handleInputChange}
                placeholder={
                  translations.page.register.placeholder.confirmPassword
                }
              />
            </div>
            <button type='submit' className='btn-register'>
              {translations.page.register.button}
            </button>
          </form>
