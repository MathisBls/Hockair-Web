...
const Dashboard = () => {
  const recentMatches = [
    ...
    },
    {
      ...
      player2: {
        name: 'Jane Smith',
        logo: 'path/to/janesmith/logo.png',
        country: 'UK',
      },
      score: '1 - 3',
      date: '2023-12-24',
    ...
    <div className='dashboard-container'>
      <div className='dashboard-banner'>
        <div className='banner-content'>
          ...
          <p>
            Challenge your friends, climb the ranks, and conquer the air hockey
            tournaments!
          </p>
          ...
          {recentMatches.map((match) => (
            <div key={match.id} className='match-card'>
              <div className='player player1'>
                ...
                <img
                  src={`https://flagcdn.com/24x18/${match.player1.country.toLowerCase()}.png`}
              ...
              <div className='player player2'>
                ...
                <img
                  src={`https://flagcdn.com/24x18/${match.player2.country.toLowerCase()}.png`}
